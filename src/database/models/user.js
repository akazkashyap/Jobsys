    ...
    html: `<html lang="en">
        ...
        <body><table><tr><td>
                        <div style="padding: 0 4em; text-align: center;">
                            <h2>We make your Job a little easy :)</h2>
                          <p><span>Thanks for signing up in Jobsys.</span>
                                <br><br>
                                Hello ${this.name.toUpperCase()}, your verification link is below, it will expire in
                                3 minutes(180 sec).
                            </p>
                            <p><a href="https://Jobsys.onrender.com/signup/user/verify?email=${
                              this.email
                            }&token=${this.otp[0].token}"
